      ...
      promises.push(new Promise(function(yay,nay){
        ...
        selectPromise.then(function(box){
          if (box == undefined) {
            ...
            // select INBOX, else the server will disconnect us after deleting the currently
            // selected folder
            var selectPromise2 = myImap.selectFolder(token,'INBOX');
            selectPromise2.then(function() {
